...
import 'package:signup/pages/pill/common/convert_time.dart';
import 'package:signup/pages/pill/global_bloc.dart';
import 'package:signup/pages/pill/models/errors.dart';
import 'package:signup/pages/pill/models/medicine.dart';
import 'package:signup/pages/pill/models/medicine_type.dart';
import 'package:signup/pages/pill/ui/homepage/homepage.dart';
import 'package:signup/pages/pill/ui/new_entry/new_entry_bloc.dart';
import 'package:signup/pages/pill/ui/success_screen/success_screen.dart';
...
class _NewEntryState extends State<NewEntry> {
  ...
  Future onSelectNotification(String payload) async {
    ...
    await Navigator.push(
      context,
      new MaterialPageRoute(builder: (context) => PillHome()),
    );
  }
  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    ...
    for (int i = 0; i < (24 / medicine.interval).floor(); i++) {
      ...
      await flutterLocalNotificationsPlugin.showDailyAtTime(
          ...
          'Wokhati minder: ${medicine.medicineName}',
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(children: <TextSpan>[
          ...
          TextSpan(
            text: isRequired ? " *" : "",
            style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold, color: Color(0xFF000000)),
          ),
        ]),
      ),
    );
